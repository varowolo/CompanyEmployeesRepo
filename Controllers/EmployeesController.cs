...
namespace CompanyEmployees.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public IActionResult GetEmployeesForCompany(Guid companyId)
        {
            ...
            var employeeDb = _repository.Employee.GetEmployees(companyId, trackchanges: false);
        ...
        public IActionResult CreateEmployeeForCompany(Guid companyId, [FromBody]EmployeeForCreationDto employee)
        {
            ...
            if (!ModelState.IsValid)
            {
                ...
                ModelState.AddModelError("ModelState", "InvalidModel state");
            ...
            return CreatedAtRoute("CompanyById", new {companyId,id = employeeToReturn.Id
            }, employeeToReturn);
